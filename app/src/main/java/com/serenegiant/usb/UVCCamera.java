...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
     ...
     * start preview
     */
    public synchronized void startPreview(boolean visible) {
    	if (mCtrlBlock != null) {
    		nativeStartPreview(mNativePtr, visible ? 1 : 0);
    	}
    }
...
//================================================================================
    ...
    private static final native int nativeStartPreview(final long id_camera,final int visible);
